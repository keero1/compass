...
// image
import backgroundImage from "../../../assets/images/bg-cover.png";
        ...
        <div className="w-full max-w-md min-w-[300px]">
          <div className="bg-base-200 text-base-content p-8 rounded-lg shadow-lg w-full">
            ...
            <form onSubmit={onSubmit}>
              <div className="mb-4">
                <label className="block text-base-content mb-2">Email</label>
                <input
                  type="email"
                  autoComplete="email"
                  required
              ...
              <div className="mb-6">
                <label className="block text-base-content mb-2">Password</label>
